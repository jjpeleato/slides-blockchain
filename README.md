...
The blockchain presentation where I explain what it is and define some terms.

## Environment

- LOCAL: http://web.blockchain.lndo.site/
- DEV: ~
- PRE: ~
- PRO: https://jjpeleato.com/courses/blockchain/
